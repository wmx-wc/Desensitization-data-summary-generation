...
def main(args):
    ...
    train_loader = build_regular_dataloader(args, data, shuffle=True)
...
if __name__ == '__main__':
    ...
    opt.filename = '/home/mixiangw/wmx/code_python/u2net/weights/4/1/video/train/train_lm_mlm/models/models/facebook/bart-base-319.pth'
    main(opt)
