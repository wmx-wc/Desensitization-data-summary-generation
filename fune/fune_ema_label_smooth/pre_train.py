...
def main(args):
    ...
    train_loader = build_my_dataloader(args, train_data, shuffle=True)
...
if __name__ == '__main__':
    ...
    opt.filename = '/home/mixiangw/wmx/code_python/u2net/weights/4/1/video/train/train_small/models/models/facebook/bart-base-259.pth'
    main(opt)
